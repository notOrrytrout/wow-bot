...
#[derive(Clone, Debug)]
pub struct RemoteMemoryPolicy { pub require_verified_tls: bool }
impl Default for RemoteMemoryPolicy { fn default() -> Self { Self { require_verified_tls: true } } }

pub fn validate_remote_endpoint(host: &str, tls: bool, verify_identity: bool, policy: &RemoteMemoryPolicy) -> Result<(), String> {
